...
import com.memorial.generator.config.*;
import com.memorial.generator.config.query.MySqlQuery;
import com.memorial.generator.config.query.SqlServerQuery;
...
import com.memorial.generator.exception.GeneratorException;
import com.memorial.generator.config.*;
import lombok.Data;
...
public class CodeGenerator {
    ...
    public void generator(String tableName, String pkIdName, GeneratorProperties generatorProperties) {
        ...
        if (DbType.MYSQL == dbType) {
            ...
            // 设置SQLServer元数据自定义查询
            dataSourceConfig.setDbQuery(new SqlServerQuery());
        }
